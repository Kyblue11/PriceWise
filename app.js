...
function runPuppeteerScript(script, keywords) {
  return new Promise((resolve, reject) => {
    ...
    // console.log("Script path:", scriptPath); // Debugging
...
app.post('/search', async (req, res) => {
    ...
    console.log(`App.js query received: ${query}`); // node app.js (old html)
    ...
    // console.log(`Rendering products for keywords: ${query}`);
});
